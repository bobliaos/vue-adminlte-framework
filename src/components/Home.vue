          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown notifications-menu">
              ...
              <ul class="dropdown-menu">
                <li class="header">你有 10 条新的消息</li>
                <li>
                  ...
                  <ul class="menu">
                    <li>
                      <!-- start notification -->
                      <a href="#">
                        <i class="fa fa-users text-aqua"></i> 新成员加入
                      </a>
                    </li>
                    <!-- end notification -->
                  </ul>
            ...
            <!-- Tasks Menu -->
            <li class="dropdown tasks-menu" v-show="false">
              <!-- Menu Toggle Button -->
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li
            ...
            :class="(item.sub_menus.length > 0 ? 'treeview' : '') + ' ' + (item.active ? 'active menu-open' : '') "
          >
